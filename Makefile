...
PutHTML:
	cp pongWebpage.css /var/www/html/class/softdev/$(USER)/project3
	cp pongWebpage.html /var/www/html/class/softdev/$(USER)/project3
	cp pong.js  /var/www/html/class/softdev/$(USER)/project3
